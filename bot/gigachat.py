...
- Поле «Ответственные»: если не указано — не упоминай ответственных вообще, не пиши «нет данных» / «не указаны».
- Поле «Документация»: если в контексте есть ссылка «Документация: [название](url)» — ВСЕГДА выводи её в конце ответа
  как «Подробнее: [название](url)». Не выдумывай ссылки.
